...
void handle_position_change(char *message) {
  ...
  while (token != NULL) {
    ...
    // Extract username, x-coordinate, and y-coordinate using sscanf with field
    // width limits NOLINTNEXTLINE(cert-err34-c,-warnings-as-errors)
